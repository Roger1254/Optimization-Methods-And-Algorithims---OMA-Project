...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		// Da riga di comando:
		if (args.length != 3 || !args[1].contains("-t"))  {
			System.out.println("Error in input parameters: Insert 'instanceXX.odbdp -t time'");
			System.exit(-1);
		}
		...
		System.out.println();
		System.out.println("Algorithm stopped at iteration " + iteration);
